...
urlpatterns = [
    ...
    path('add-your-prediction-top-16/edit/<int:pk>', views.UpdateBetViewTop16.as_view(), name='update_bets_top_16'),
    path('add-your-prediction-quarter-finals/edit/<int:pk>', views.UpdateBetViewTop8.as_view(), name='update_bets_quarter'),
